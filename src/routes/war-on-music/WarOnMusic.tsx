  ...
  return (
    <>
      ...
      <p>
        ...
        Academic Senate this coming Wednesday, January 10th, at 4:00 PM. ... The
        sole agenda item shall be hearing the Administration provide the data
        and information generated by a review of overall staff needs based upon
      ...
      <p>
        ...
        but only the BM in Composition, the BA in Music, the MM in Composition,
        and the MM in Jazz Studies. “The Dana School of Music will undergo an
        immediate reorganization to enhance and rejuvenate the school to better
      ...
      <ol className="mx-4">
        ...
        <li>
          ...
          10,000 unique views, and the related petition gathered more than 6300
          signatures (as of this message going live).
        </li>
      </ol>
      ...
      <p>
        ...
        <strong>their</strong> idea of marketability—particularly a school like
        Dana with thousands of successful graduates thriving throughout the
        region, the nation, and the world. This community matters, and your
        voice matters, and the Dana School of Music matters.{" "}
